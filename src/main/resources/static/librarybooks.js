	...
	function bookList() {
	    ...
	    $.ajax({
	        url: 'http://34.212.20.199:31355/books',
	        type: 'GET',
	        dataType: 'json',
	...
	function bookUpdate(book) {
	    $.ajax({
	        url: "http://34.212.20.199:31355/books/" + book.id,
	        type: 'PUT',
	...
	function bookGet(ctl) {
	    ...
	    $.ajax({
	        url: "http://34.212.20.199:31355/books/" + id,
	        type: 'GET',
	        dataType: 'json',
	        success: function(book) {
	            bookToFields(book);
   ...
   function searchBoook(){
		...
		$.ajax({
	        url: 'http://34.212.20.199:31355/books/searchbook/' + book_name,
	        type: 'GET',
	        dataType: 'json',
	        success: function(books) {
	        	$("#tableid").empty();
	...
	function searchAuthor(){
	   var author_name = $("#searchauthor").val();
		$.ajax({
	        url: 'http://34.212.20.199:31355/books/searchauthor/' + author_name,
	        type: 'GET',
	        dataType: 'json',
	        success: function(books) {
	        	$("#tableid").empty();
	...
	function searchCategory(){
		...
		$.ajax({
	        url: 'http://34.212.20.199:31355/books/searchcategory/' + category_name,
	        type: 'GET',
	        dataType: 'json',
	        success: function(books) {
	        	formClear();
